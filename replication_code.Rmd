...
```{r}
#Producing Log of Price by Geographic Treatment graphics 
# 1 Kilometer Control
...
m.out0 <- matchit(CoreBin ~  SalePrice+ Age+ FinishArea+ PrcntWhite+ BAorHigher + BuildPreTrt, data = DTC_DID_Full,
...
m.out1 <- matchit(CoreBin ~  SalePrice+ Age+ FinishArea+ PrcntWhite+ BAorHigher + BuildPreTrt, data = psvalue_top,
                 method = NULL, distance = "glm")
# Checking balance after to matching
summary(m.out1)

gpsvalue_top <- DTC_DID_Full_Control[order(-DTC_DID_Full_Control$gpsvalue), ][1:10000, ]
gpsvalue_top<- rbind(gpsvalue_top, DTC_DID_Full_Treat)
m.out2 <- matchit(CoreBin ~  SalePrice+ Age+ FinishArea+ PrcntWhite+ BAorHigher + BuildPreTrt, data = gpsvalue_top,
                 method = NULL, distance = "glm")
# Checking balance after to matching
summary(m.out2)


rf_psvalue_top <- DTC_DID_Full_Control[order(-DTC_DID_Full_Control$rf_psvalue), ][1:10000, ]
rf_psvalue_top <- rbind(rf_psvalue_top, DTC_DID_Full_Treat)
m.out3 <- matchit(CoreBin ~  SalePrice+ Age+ FinishArea+ PrcntWhite+ BAorHigher + BuildPreTrt, data = rf_psvalue_top,
                 method = NULL, distance = "glm")
# Checking balance after to matching
summary(m.out3)
...
stargazer(DIDmodelmps,DIDmodelmgps,DIDmodelmrf,type ='latex')
stargazer(DIDmodelmps.1,DIDmodelmgps.1,DIDmodelmrf.1,type ='latex')
...
################### creating event study using matched data ########################
...
stargazer(DIDpsvalue_top,DIDgpsvalue_top,DIDrf_psvalue_top,type="latex" )
stargazer(DIDpsvalue_top1,DIDgpsvalue_top1,DIDrf_psvalue_top1,type="latex" )
...
#################### Running the Q-DiD with Matched sample ###################
...
```{r}
#Difference-in-Differences by time period (2010-2015, 2016-2023)
...
stargazer(DIDmodel1,DIDmodel3,DIDmodel5, DIDmodel10,type="latex" )
stargazer(DIDmodel1.1,DIDmodel3.1,DIDmodel5.1, DIDmodel10.1,type="latex" )
...
# Display the summary with stargazer
stargazer(summary_Mean, type = "text", summary = FALSE, title = "Mean Sale Price by Group and Period")
...
# Display the summary with stargazer
stargazer(summary_Mean1, type = "text", summary = FALSE, title = "Mean Sale Price by Group and Period")
...
# Display the summary with stargazer
stargazer(summary_Combo, type = "text", summary = FALSE, title = "Mean Sale Price by Group and Period")




########## Interpriting ceoficients ##########
...
sum_Treat_DTC_DIDT0_C1 <- add_identifiers(sum_Treat_DTC_DIDT0_C1, "Treatment (DTC)", "T0")
sum_Treat_DTC_DIDT1_C1 <- add_identifiers(sum_Treat_DTC_DIDT1_C1, "Treatment (DTC)", "T1")
sum_PSM_DTC_DIDT0_C0 <- add_identifiers(sum_PSM_DTC_DIDT0_C0, "PSM Control", "T0")
sum_PSM_DTC_DIDT1_C0 <- add_identifiers(sum_PSM_DTC_DIDT1_C0, "PSM Control", "T1")
sum_GBM_DTC_DIDT0_C0 <- add_identifiers(sum_GBM_DTC_DIDT0_C0, "GBM Control", "T0")
sum_GBM_DTC_DIDT1_C0 <- add_identifiers(sum_GBM_DTC_DIDT1_C0, "GBM Control", "T1")
sum_RFM_DTC_DIDT0_C0 <- add_identifiers(sum_RFM_DTC_DIDT0_C0, "RFM Control", "T0")
sum_RFM_DTC_DIDT1_C0 <- add_identifiers(sum_RFM_DTC_DIDT1_C0, "RFM Control", "T1")
...
# Display the summary with stargazer
stargazer(summary_Mean1, type = "latex", summary = FALSE, title = "Mean Sale Price by Group and Period")
...
# Display the summary with stargazer
stargazer(summary_Combo, type = "latex", summary = FALSE, title = "Mean Sale Price by Group and Period")
