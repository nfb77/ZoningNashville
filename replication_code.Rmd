...
# Display the summary with stargazer
stargazer(summary_Mean1, type = "latex", summary = FALSE, title = "Mean Sale Price by Group and Period",digits=0)
...
# Display the summary with stargazer
stargazer(summary_Combo, type = "latex", summary = FALSE, title = "Mean Sale Price Per Square Foot by Group and Period")
...
# Display the summary with stargazer
stargazer(summary_Combo1, type = "latex", summary = FALSE, title = "Mean Sale Price Per Square Foot by Group and Period")
...
########## Interpreting Logged ceoficients ##########
