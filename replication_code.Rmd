...
```{r}
#Matching Methods, with difference in differences
...
stargazer(DIDpsvalue_top,DIDgpsvalue_top,DIDrf_psvalue_top1,type="text" )
...
#only comparing balance for pre-treatement
DID1k <-  subset(DID1k, TimeBin == 0)
DID3k <-  subset(DID3k, TimeBin == 0)
DID5k <-  subset(DID5k, TimeBin == 0)
DID10k <-  subset(DID10k, TimeBin == 0)


# Treated vs Untreated (1km boundary)
m.out1 <- matchit(CoreBin ~  SalePrice+ Age+ FinishArea+ PrcntWhite+ BAorHigher + BuildPreTrt, data = DID1k,
                 method = NULL, distance = "glm")
summary(m.out1)

# Treated vs Untreated (1km boundary)
m.out3 <- matchit(CoreBin ~ SalePrice+ Age+ FinishArea+ PrcntWhite+ BAorHigher + BuildPreTrt, data = DID3k,
                 method = NULL, distance = "glm")
summary(m.out3)

# Treated vs Untreated (1km boundary)
m.out5 <- matchit(CoreBin ~ SalePrice+ Age+ FinishArea+ PrcntWhite+ BAorHigher + BuildPreTrt, data = DID5k,
                 method = NULL, distance = "glm")
summary(m.out5)


# Treated vs Untreated (1km boundary)
m.out10 <- matchit(CoreBin ~ SalePrice+ Age+ FinishArea+ PrcntWhite+ BAorHigher + BuildPreTrt, data = DID10k,
                 method = NULL, distance = "glm")
summary(m.out10)
...
DTC_DID_Full <- read.csv("Full_Control.csv")
...
DTC_DID_Full <- read_excel("data/DTC_DID1K.xlsx",sheet = "Multifam 00-23")
DTC_DID_Full <- DTC_DID_Full[,1:23]
DTC_DID_Full <- DTC_DID_Full[DTC_DID_Full$SalePrice < 2500000 & DTC_DID_Full$SalePrice >= 1, ]
...
DTC_DID_Full <- read_excel("data/DTC_DID3K.xlsx",sheet = "Multifam 00-23")
DTC_DID_Full <- DTC_DID_Full[,1:23]
DTC_DID_Full <- DTC_DID_Full[DTC_DID_Full$SalePrice < 2500000 & DTC_DID_Full$SalePrice >= 1, ]
#DTC_DID_Full <- DTC_DID_Full[DTC_DID_Full$SalePrice < 5910346 & DTC_DID_Full$SalePrice >= 1, ]
DTC_DID_Full$FinishArea[DTC_DID_Full$FinishArea == 0] <- 449
...
DTC_DID_Full <- read_excel("data/DTC_DID5K.xlsx",sheet = "Multifam 00-23")
DTC_DID_Full <- DTC_DID_Full[,1:23]
DTC_DID_Full <- DTC_DID_Full[DTC_DID_Full$SalePrice < 2500000 & DTC_DID_Full$SalePrice >= 1, ]
#DTC_DID_Full <- DTC_DID_Full[DTC_DID_Full$SalePrice < 5910346 & DTC_DID_Full$SalePrice >= 1, ]
DTC_DID_Full$FinishArea[DTC_DID_Full$FinishArea == 0] <- 449
...
DTC_DID_Full <- read_excel("data/DTC_DID10K.xlsx",sheet = "Multifam 00-23")
DTC_DID_Full <- DTC_DID_Full[,1:23]
DTC_DID_Full <- DTC_DID_Full[DTC_DID_Full$SalePrice < 2500000 & DTC_DID_Full$SalePrice >= 1, ]
#DTC_DID_Full <- DTC_DID_Full[DTC_DID_Full$SalePrice < 5910346 & DTC_DID_Full$SalePrice >= 1, ]
DTC_DID_Full$FinishArea[DTC_DID_Full$FinishArea == 0] <- 449
